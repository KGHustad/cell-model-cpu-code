                  ...
                  cellmodel_float_t **t_trace_ptr, int *trace_length)
{
    ...
    cellmodel_float_t *t_trace = malloc(num_stored_timesteps * sizeof(cellmodel_float_t));
    cellmodel_float_t *V_trace = malloc(num_stored_timesteps * sizeof(cellmodel_float_t));
    ...
    if (model->layout == LAYOUT_ARRAY_OF_STRUCTS) {
        V_ind_2d = V_index;
    }
