                    ...
                    const long num_cells, long padded_num_cells)
{
    #pragma omp parallel
    {
        ...
        const cellmodel_float_t lambda_Na = parameters[PARAM_lambda_Na];
        const cellmodel_float_t g_NaL = parameters[PARAM_g_NaL];
        const cellmodel_float_t thL = parameters[PARAM_thL];
        const cellmodel_float_t KmKo = parameters[PARAM_KmKo];
        const cellmodel_float_t KmNaip = parameters[PARAM_KmNaip];
        const cellmodel_float_t g_NaK = parameters[PARAM_g_NaK];
        ...
        const cellmodel_float_t g_KATP = parameters[PARAM_g_KATP];
        const cellmodel_float_t g_Kr = parameters[PARAM_g_Kr];
        const cellmodel_float_t lambda_K = parameters[PARAM_lambda_K];
        const cellmodel_float_t g_to = parameters[PARAM_g_to];
        const cellmodel_float_t g_K1 = parameters[PARAM_g_K1];
        const cellmodel_float_t g_bCl = parameters[PARAM_g_bCl];
        ...
        const cellmodel_float_t g_NaCa = parameters[PARAM_g_NaCa];
        ...
        const cellmodel_float_t E_f = parameters[PARAM_E_f];
        const cellmodel_float_t g_f = parameters[PARAM_g_f];
        const cellmodel_float_t Nao = parameters[PARAM_Nao];
        const cellmodel_float_t K_i = parameters[PARAM_K_i];
        const cellmodel_float_t Ko = parameters[PARAM_Ko];
        const cellmodel_float_t ce = parameters[PARAM_ce];
        const cellmodel_float_t K_RyR = parameters[PARAM_K_RyR];
        const cellmodel_float_t alpha_RyR = parameters[PARAM_alpha_RyR];
        const cellmodel_float_t beta_RyR = parameters[PARAM_beta_RyR];
        const cellmodel_float_t eta_RyR = parameters[PARAM_eta_RyR];
        const cellmodel_float_t gamma_RyR = parameters[PARAM_gamma_RyR];
        const cellmodel_float_t lambda_RyR = parameters[PARAM_lambda_RyR];
        const cellmodel_float_t Vc = parameters[PARAM_Vc];
        const cellmodel_float_t Vd = parameters[PARAM_Vd];
        const cellmodel_float_t Vn = parameters[PARAM_Vn];
        const cellmodel_float_t Vs = parameters[PARAM_Vs];
        const cellmodel_float_t Vsl = parameters[PARAM_Vsl];
        const cellmodel_float_t J_SERCA_bar = parameters[PARAM_J_SERCA_bar];
        const cellmodel_float_t K_c = parameters[PARAM_K_c];
        const cellmodel_float_t K_n = parameters[PARAM_K_n];
        const cellmodel_float_t B_tot_c = parameters[PARAM_B_tot_c];
        const cellmodel_float_t B_tot_d = parameters[PARAM_B_tot_d];
        const cellmodel_float_t B_tot_s = parameters[PARAM_B_tot_s];
        const cellmodel_float_t B_tot_sl = parameters[PARAM_B_tot_sl];
        const cellmodel_float_t k_off_c = parameters[PARAM_k_off_c];
        const cellmodel_float_t k_off_d = parameters[PARAM_k_off_d];
        const cellmodel_float_t k_off_s = parameters[PARAM_k_off_s];
        const cellmodel_float_t k_off_sl = parameters[PARAM_k_off_sl];
        const cellmodel_float_t k_on_c = parameters[PARAM_k_on_c];
        const cellmodel_float_t k_on_d = parameters[PARAM_k_on_d];
        const cellmodel_float_t k_on_s = parameters[PARAM_k_on_s];
        const cellmodel_float_t k_on_sl = parameters[PARAM_k_on_sl];
        const cellmodel_float_t lambda_B = parameters[PARAM_lambda_B];
        const cellmodel_float_t lambda_B_c = parameters[PARAM_lambda_B_c];
        const cellmodel_float_t alpha_d_c = parameters[PARAM_alpha_d_c];
        const cellmodel_float_t alpha_n_s = parameters[PARAM_alpha_n_s];
        const cellmodel_float_t alpha_sl_c = parameters[PARAM_alpha_sl_c];
        const cellmodel_float_t lambda_c_d = parameters[PARAM_lambda_c_d];
        const cellmodel_float_t lambda_c_i = parameters[PARAM_lambda_c_i];
        const cellmodel_float_t lambda_diff = parameters[PARAM_lambda_diff];
        ...
        const cellmodel_float_t chi = parameters[PARAM_chi];
        const cellmodel_float_t lambda_c_e = parameters[PARAM_lambda_c_e];
...
// clang-format off
const struct cellmodel model_JT21_simd = {
