...
void JT21_step_FE(double *__restrict states, const double t, const double dt,
...
void JT21_step_GRL1(double *__restrict states, const double t, const double dt,
                          const double *__restrict parameters, const long num_cells,
                          long padded_num_cells)
{
    #pragma omp parallel for
...
// clang-format off
const struct cellmodel model_JT21_naive = {
        .init_states = &init_states_omp,
        .init_parameters = &init_parameters_values,
        .state_index = &state_index,
        .parameter_index = &parameter_index,
        .step_FE = &JT21_step_FE,
        .step_RL = NULL,
        .step_GRL1 = &JT21_step_GRL1,
